      ...
      let(:expected_table) do
        {
          ...
          values: [
            ...
            [I18n.t('duty_calculations.options.import_duty_html', commodity_source: commodity_source.upcase, option_type: 'Tariff preference', additional_code: nil), '5.0% * £1,050.00', '£52.50'],
