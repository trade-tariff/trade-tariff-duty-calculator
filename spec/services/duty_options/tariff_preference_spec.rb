      ...
      let(:expected_table) do
        {
          ...
          values: [
            ...
            [I18n.t('duty_calculations.options.import_duty_html', commodity_source: 'EU', option_type: 'Tariff preference', additional_code: nil), '35.10 EUR / 100 kg * 120.00', '£3,610.11'],
