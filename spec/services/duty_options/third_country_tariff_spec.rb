        ...
        let(:expected_table) do
          {
            ...
            values: [
              [I18n.t('duty_calculations.options.import_valuation'), I18n.t('duty_calculations.options.customs_value'), '£1,050.00'],
              [I18n.t('duty_calculations.options.import_quantity'), nil, '120 x 100 kg'],
              [I18n.t('duty_calculations.options.import_duty_html', commodity_source: 'EU', option_type: 'Third-country duty', additional_code: nil), '35.10 EUR / 100 kg * 120', '£3,596.12'],
        ...
        let(:expected_table) do
          {
            ...
            values: [
              ...
              [I18n.t('duty_calculations.options.import_duty_html', commodity_source: 'EU', option_type: 'Third-country duty', additional_code: nil), '35.10 EUR / 100 kg * 0.00001', '£0.00'],
